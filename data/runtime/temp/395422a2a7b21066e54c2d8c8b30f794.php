<?php /*a:2:{s:77:"D:\phpstudy8\WWW\thinkcmf\public/themes/admin_simpleboot3/admin\user\add.html";i:1568466725;s:76:"D:\phpstudy8\WWW\thinkcmf\public/themes/admin_simpleboot3/public\header.html";i:1568903174;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('user/addpost'); ?>">
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control" placeholder="请输入姓名" id="input-user_login" name="user_login">
            </div>
            <label for="input-user_pass" class="col-sm-1 control-label"><span class="form-required">*</span>工号</label>
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control" placeholder="请输入工号" id="input-user_pass" name="account"
                       placeholder="******">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-10">
                <?php if(is_array($sexs) || $sexs instanceof \think\Collection || $sexs instanceof \think\Paginator): if( count($sexs)==0 ) : echo "" ;else: foreach($sexs as $k=>$vo): $defaultSelected=$defaultSex==$k?"checked":""; ?>
            ...
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control" placeholder="请输入手机号" id="input-user_mobile" name="mobile">
            </div>
        </div>
        <div class="form-group">
            <label for="input-user_login" class="col-sm-1 control-label">证件类型</label>
            <div class="col-md-3 col-sm-10">
                <?php if(is_array($cards) || $cards instanceof \think\Collection || $cards instanceof \think\Paginator): if( count($cards)==0 ) : echo "" ;else: foreach($cards as $k=>$vo): $defaultChecked=$defaultCard==$k?"checked":""; ?>
                    <label class="radio-inline">
            ...
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control" id="input-user_pass" name="card_id" placeholder="请输入证件号码">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control js-bootstrap-date" placeholder="请选择入职时间" id="input-user_login"
                       name="join_time">
            </div>
            <label for="input-user_pass" class="col-sm-1 control-label">QQ</label>
            <div class="col-md-3 col-sm-10">
                <input type="text" class="form-control" id="input-user_pass" name="qq" placeholder="请输入QQ">
            </div>
        </div>
        <div class="form-group">
            <label for="input-user_role_id" class="col-sm-1 control-label"><span class="form-required">*</span><?php echo lang('ROLE'); ?></label>
            <div class="col-md-6 col-sm-10">
                <?php if(is_array($roles) || $roles instanceof \think\Collection || $roles instanceof \think\Paginator): if( count($roles)==0 ) : echo "" ;else: foreach($roles as $ke=>$vo): $defaultVal=$ke==2?"checked":""; ?>
                    <label class="radio-inline">
                        <input value="<?php echo $vo['id']; ?>" type="radio" <?php echo $defaultVal; ?> name="role_id[]"><?php echo $vo['name']; ?>
                    </label>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-7 col-sm-10">
                <textarea type="textarea" rows="5" class="form-control" id="input-user_login" name="remark"></textarea>
            </div>
        </div>
        <div class="form-group">
