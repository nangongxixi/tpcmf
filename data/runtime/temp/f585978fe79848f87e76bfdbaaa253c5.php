<?php /*a:2:{s:81:"D:\phpstudy8\WWW\thinkcmf\public/themes/admin_simpleboot3/admin\mailer\index.html";i:1568298171;s:76:"D:\phpstudy8\WWW\thinkcmf\public/themes/admin_simpleboot3/public\header.html";i:1568298171;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <a class="btn btn-warning"
                   href="javascript:parent.openIframeDialog('<?php echo url('mailer/test'); ?>','发送测试邮件',{width:'600px',height:'400px'});">测试邮件</a>
            </div>
        </div>
    </form>
</div>
