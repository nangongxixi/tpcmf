<?php /*a:1:{s:80:"D:\phpstudy_pro\WWW\tpcmf\public/themes/admin_simpleboot3/admin\index\index.html";i:1569723024;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>鼎健医学 <?php echo lang('ADMIN_CENTER'); ?></title>
...
<div id="right-tools-wrapper"></div>
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">鼎健医学管理系统</a>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
                ...
                <li class="light-blue" style="border-left:none;">
                    <a href="javascript:openapp('/admin/message/notice.html','168admin','通知管理',true);" style="padding: 11px 5px 10px 5px">
                        <div class="label label-danger" id="notice-nums" title="通知数量"
                             style="padding:.35em; display: block !important; min-width: 26px; height: 26px; border-radius: 50%; font-size: 115%">
                            0
                        </div>
                    </a>
                </li>
                <li class="light-blue" style="border-left:none;">
                    <a href="javascript:openapp('/admin/message/search.html','169admin','聊天记录管理',true);" style="padding: 11px 5px 10px 5px">
                        <div class="label label-warning" title="消息数量"
                             style="padding:.35em; display: block !important; min-width: 26px; height: 26px; border-radius: 50%; font-size: 115%"
                             id="message-nums">0
                        </div>
                    </a>
...
<script>
    setInterval(function () {
        $.get("<?php echo API_ADDR; ?>/" + 'message/user/nums', function (res) {
            $('#notice-nums').html(res.data.notice);
            $('#message-nums').html(res.data.message);
        })
    }, 3000);
