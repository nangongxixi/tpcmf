<?php /*a:1:{s:75:"D:\phpstudy_pro\WWW\tpcmf\public/themes/admin_simpleboot3/admin\\login.html";i:1569659646;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
...
<body style="background: url('/static/images/bg.jpg'); background-position: center; background-size: auto">
<div class="wrap">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <img src="/themes/admin_simpleboot3/public/assets/images/logo.png" style="width: 100%; margin-bottom: 20px">
...
<input type="hidden" name="_captcha_id" value="">
                    ...
                    <p style="text-align: right; cursor: pointer" id="forgetPwd">忘记密码？</p>
